...
public class PantallaPrincipal extends javax.swing.JFrame {
    ...
    private void refrescarTabla(){
        ...
        List<Clientes> listaClientes  = LogicaNegocio.getListaClientes();
        for(Clientes clientes:listaClientes){
            dtm.addRow(clientes.toArrayString());
        }
        
        jTableClientes.setModel(dtm);
    }
    
   /* public void anadirClientes(Clientes clientes){
    ...
    public void recibirDatos(Clientes cliente){
    }
    /**
